...
data class ProjectDraft(
    ...
    var sourceTechnology: String = "web-static",
    var sourceTechnologyLabel: String = "HTML / CSS / JavaScript",
    var sourceBuildEngine: String = "webview-static",
    var sourceBuildReady: Boolean = true,
    var webUrl: String = "",
